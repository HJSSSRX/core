...
class ResilienceWrapper:
    ...
    def __init__(
        self, max_retries: int = 3, timeout: float = 120.0, circuit_threshold: int = 5, circuit_cooldown: float = 60.0
    ):
    ...
    async def complete(
        self, backend: LLMBackend, messages: list[Message], tools: list[dict[str, Any]] | None = None, **kwargs
    ) -> LLMResponse:
